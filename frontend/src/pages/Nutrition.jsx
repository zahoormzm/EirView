...
export default function Nutrition() {
  const { dashboard, selectedUserId, showToast } = useStore();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
        <FileUpload accept=".jpg,.jpeg,.png" label="Meal Photo" endpoint={uploadPhoto} onUpload={setAnalysis} />
