  ...
  return (
    <div className="relative">
      <button
        ...
        className="min-w-[220px] rounded-xl border border-slate-300 bg-white px-3 py-2 text-left shadow-sm hover:border-emerald-300"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-[320px] rounded-2xl border border-slate-200 bg-white p-3 shadow-xl z-50">
